...
const deSlugs = {
  ...
  "gold-and-silver-calculator": "gold-und-silber-rechner",
  "silver-melt-value-calculator": "silber-schmelzwert-rechner",
  "sterling-silver-calculator": "sterlingsilber-rechner",
  "junk-silver-calculator": "billon-silber-rechner",
  "silver-coin-value-calculator": "silbermuenzen-wert-rechner",
  "silver-bar-value-calculator": "silberbarren-wert-rechner",
  "silver-jewelry-value-calculator": "silberschmuck-wert-rechner",
  "silverware-value-calculator": "silberbesteck-wert-rechner",
  "999-silver-calculator": "999-feinsilber-rechner",
  "958-silver-calculator": "958-britanniasilber-rechner",
  "925-silver-calculator": "925-sterlingsilber-rechner",
  "900-silver-calculator": "900-muenzsilber-rechner",
  "835-silver-calculator": "835-silber-rechner",
  "800-silver-calculator": "800-silber-rechner",
  ...
  "silver-price-all-currencies": "silberpreis-alle-waehrungen",
  ...
  "silver-batch-calculator": "silber-stapel-rechner",
  "sona-chandi-calculator": "sona-chandi-rechner",
  "face-value-silver-calculator": "nennwert-silber-rechner",
  "silver-weight-converter": "silber-gewichtsumrechner",
  "pennyweight-calculator": "pennyweight-dwt-rechner",
  "tola-calculator": "tola-rechner",
  "silver-sell-or-hold": "silber-verkaufen-oder-halten",
  "identify-silver": "silber-identifizieren",
  "how-to-use-silver-calculators": "wie-man-silberrechner-verwendet",
  "what-is-silver-scrap": "was-ist-silberschrott",
  "what-is-silver-melt-value": "was-ist-silberschmelzwert",
  "what-is-junk-silver": "was-ist-billon-silber",
  "what-is-troy-ounce": "was-ist-eine-feinunze",
  ...
  "silver-bracelet-value": "silberarmband-wert",
  "silver-chain-value": "silberkette-wert",
  "silver-cup-value": "silberbecher-wert",
  "silver-dime-calculator": "silber-dime-rechner",
  "silver-dollar-calculator": "silber-dollar-rechner",
  "silver-fork-value": "silbergabel-wert",
  "silver-knife-value": "silbermesser-wert",
  "silver-necklace-value": "silberhalskette-wert",
  "silver-plate-value": "silberteller-wert",
  "silver-quarter-calculator": "silber-quarter-rechner",
  "silver-ring-value": "silberring-wert",
  "silver-spoon-value": "silberloeffel-wert",
  "silver-tray-value": "silbertablett-wert",
  "canadian-silver-coin-calculator": "kanadische-silbermuenzen-rechner"
};
...
function injectDictionaryOnly() {
  ...
  for (const file of files) {
    ...
    // Remove existing window.MenuTranslations entries completely
    content = content.replace(/window\.MenuTranslations\s*=\s*\{.*?\}\s*;/g, '');
    content = content.replace(/window\.MenuTranslations\s*=\s*\{\}\s*;/g, '');

    // Now securely append it
    if (!content.includes(jsInjection)) {
  ...
  console.log(`Injected German MenuTranslations into \${processCount} files.`);
}

injectDictionaryOnly();
