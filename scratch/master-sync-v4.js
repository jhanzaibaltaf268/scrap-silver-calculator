...
const L_DICTS = {
  ...
  de: Object.assign({ slugs: {} }, DE_LABELS)
};
...
LANGS.forEach(lang => {
    ...
    console.log(`Sync V4 (Head Injection) completed for /${lang}/ (${count} files).`);
});

console.log('ALL FIXES APPLIED WITH HEAD INJECTION.');
